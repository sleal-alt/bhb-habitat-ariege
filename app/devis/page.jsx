    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "var(--bg)" }}>
        <div className="max-w-md w-full text-center p-10 rounded-3xl border" style={{ background: "var(--card)", borderColor: "var(--border)" }}>
          <CheckCircle className="w-16 h-16 mx-auto mb-5" style={{ color: "var(--green)" }} />
        ...
        <form onSubmit={submit} className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input required value={form.nom} onChange={set("nom")} placeholder="Jean Dupont" className="w-full px-4 py-3 rounded-xl border text-sm outline-none focus:ring-2" style={{ borderColor: "var(--border)", background: "var(--card)", color: "var(--fg)", "--tw-ring-color": "var(--primary)" }} />
            </div>
            <div>
          ...
          <button type="submit" className="w-full flex items-center justify-center gap-2 py-5 rounded-xl font-bold text-white text-base transition-all hover:scale-[1.01] active:scale-99" style={{ background: "var(--primary)" }}>
